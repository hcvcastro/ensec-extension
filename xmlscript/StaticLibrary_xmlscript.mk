...
$(eval $(call gb_StaticLibrary_StaticLibrary,xmlscript))

$(eval $(call gb_StaticLibrary_use_external,xmlscript,boost_headers))

$(eval $(call gb_StaticLibrary_use_custom_headers,xmlscript,sdkapi/sdkapi))
...
$(eval $(call gb_StaticLibrary_add_exception_objects,xmlscript,\
